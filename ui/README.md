...
Open `ui/dashboard.html` directly to view the dashboard shell with always-visible menu and task bars. The shell remains visible even if JavaScript or network requests fail.
